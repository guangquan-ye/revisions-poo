...
class Product {
   ...
   public function __construct($id=null, $name=null, $category_id=null, $photos=null, $price=null, $description=null, $quantity=null, $createdAt=null, $updatedAt=null) {
    ...
    public function create(){
        ...
        $query = "INSERT INTO product (id, name, category_id, photos, price, description, quantity, createdAt, updatedAt) VALUES (:id, :name, :category_id, :photos, :price, :description, :quantity, :createdAt, :updatedAt)";
